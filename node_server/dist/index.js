 ...
 */
export function initGameConnections(gameId) {
 ...
 */
export function broadcastGameState(gameId, game) {
...
async function startServer() {
    ...
    app.post('/api/register', async (req, res) => {
        ...
        try {
            ...
            await db.run('INSERT INTO users (id, name, hashedPassword) VALUES (?, ?, ?)', [newPlayerId, name, hashedPassword]);
    ...
    app.post('/api/games', async (req, res) => {
        ...
        try {
            ...
            const type = gameType || GameType.SCRABBLE_CLASSIC;
